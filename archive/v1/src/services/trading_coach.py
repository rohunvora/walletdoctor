#!/usr/bin/env python3
"""
Trading Coach Service - Production-ready pattern matching for the Telegram bot
Uses Cielo API for historical P&L data and provides pattern-based coaching
"""
...
class TradingCoach:
    ...
    async def get_coaching_for_trade(
        ...
        Args:
            ...
            sol_amount: Amount of SOL they want to trade
            token_symbol: Optional token they're looking at
            
        Returns:
            Dict with coaching message and insights
        """
        try:
            # Get historical data
    ...
    async def _fetch_cielo_data(self, wallet: str) -> List[Dict]:
        """Fetch token P&L data from Cielo API with caching"""
...
async def get_trade_coaching(
    ...
    - show_trade_button: whether to show trade execution button
    """
